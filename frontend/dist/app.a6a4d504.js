  ...
  _createClass(JobSearch, [{
    ...
    value: function setCountryCode() {
      ...
      fetch('http://ip-api.com/json').then(function (results) {
        ...
        _this.countryCode = results.countryCode.toLowerCase(); //  this.setCurrencySymbol();
      });
    }
  }, {
    key: "setCurrencyCode",
      ...
      this.searchForm.addEventListener('submit', function (event) {
        ...
        switch (location) {
          case 'london':
            ...
            _this2.countryCode = 'gb';
            break;

          case 'arizona':
            //Statements executed when the
            //result of expression matches us
            _this2.countryCode = 'us';
            break;

          case 'montreal':
            //Statements executed when the
            //result of expression matches ca
            _this2.countryCode = 'ca';
            break;

          default:
            //Statements executed when none of
            //the values match the value of the expression
            _this2.countryCode = 'de';
            break;
        }

        var searchURL = "http://localhost:7000/?search=".concat(search, "&location=").concat(location, "&country=").concat(_this2.countryCode); // const searchURL = `http://localhost:7000/?search=php`;
...
// Main
console.log('after Importing / before job-search'); // params in job search class are the css classes / ids

var jobSearch = new _JobSearch.JobSearch('#search-form', '.result-container', '.loading-element');
console.log('after job search function');
